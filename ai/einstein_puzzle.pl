% einstein_puzzle(Street, Lans) is true is term Lans is list of solutions of einstein puzzle, and term Street is placement of houses
...
test(test06) :- solve_puzzle([
  house(yellow, norwegian, fox, water, kools), 
  house(blue, ukrainian, horse, tea, chesterfields), 
  house(red, englishman, snails, milk, winston), 
  house(green, japanese, zebra, coffee, parliaments), 
  house(ivory, spaniard, dog, juice, lucky_strike)], 
  [japanese, norwegian]).
